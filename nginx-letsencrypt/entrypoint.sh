...
if [[ ! -f /usr/share/nginx/certificates/cert.crt ]]; then
    ...
    # "/C=PT/ST=World/L=World/O=${DOMAIN:-techrecruiterapp.com}/OU=omarsalka/CN=${DOMAIN:-techrecruiterapp.com}/EMAIL=${EMAIL:-omarsalka9@gmail.com}"
    "/C=PT/ST=World/L=World/O=www.techrecruiterapp.com}/OU=omarsalka/CN=www.techrecruiterapp.com}/EMAIL=omarsalka9@gmail.com}"
